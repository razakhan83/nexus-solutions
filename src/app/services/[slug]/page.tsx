...
export default function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-950 selection:bg-purple-900 selection:text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <Button variant="default" className="bg-purple-600 hover:bg-purple-700 text-white rounded-full h-14 px-8 text-lg font-medium shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all" render={<a href="/#contact" />} nativeButton={false}>
      ...
      {/* CTA */}
      <section className="py-24 sm:py-32 bg-purple-950 text-center">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-5xl mb-6">Ready to scale your business?</h2>
          <p className="text-xl leading-relaxed text-purple-200 mb-10">
            Let's discuss how our {service.title} expertise can drive measurable growth for your enterprise.
          </p>
          <Button variant="outline" className="bg-white hover:bg-zinc-100 border-white text-purple-950 rounded-full h-14 px-10 text-lg font-bold shadow-lg hover:-translate-y-1 transition-all" render={<a href="/#contact" />} nativeButton={false}>
